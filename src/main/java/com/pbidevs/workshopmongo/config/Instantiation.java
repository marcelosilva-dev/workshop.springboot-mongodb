package com.pbidevs.workshopmongo.config;
...
import com.pbidevs.workshopmongo.dto.AuthorDTO;
import com.pbidevs.workshopmongo.dto.CommentDTO;
import com.pbidevs.workshopmongo.repositories.PostRepository;
import com.pbidevs.workshopmongo.repositories.UserRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018").toString(), 
				"Partiu viagem", "Vou viajar para São Paulo abraços!", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2018").toString(), 
